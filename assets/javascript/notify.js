      ...
      $.get(songkickQuery).done(function(songkickData) {
        ...
        for (var i = 0; i < 10; i++) {  
          ...
          $(".showlist").append(`
            ...
            <div class="row"> 
            <div class="col-lg-6 col-md-12 col-sm-12 artist"> ${songkickData.resultsPage.results.event[i].performance["0"].artist.displayName}</div>
            <div class="col-lg-6 col-md-12 col-sm-12 venue">@ ${songkickData.resultsPage.results.event[i].venue.displayName}</div>
            </div>
            <div class="row"> 
